...
export function Footer() {
  return (
    <footer style={{
      ...
      <div style={{
        height: 1,
        background: "linear-gradient(90deg, transparent, rgba(113,113,122,0.5), rgba(113,113,122,0.3), transparent)",
      }} />
      ...
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(113,113,122,0.04) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
        ...
        <div style={{
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {SOCIALS.map(({ icon: Icon, href, label }) => (
                <a key={label} href={href}
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "rgba(113,113,122,0.12)";
                    e.currentTarget.style.borderColor = "rgba(113,113,122,0.3)";
          ...
          <div>
            <h4 style={{
              ...
              <span style={{ width: 16, height: 2, background: "#71717a", borderRadius: 99, display: "inline-block" }} />
              Services
            </h4>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                <div style={{
                  ...
                  <MapPin style={{ width: 14, height: 14, color: "#71717a" }} />
                </div>
              ...
              <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                <div style={{
                  ...
                  <Mail style={{ width: 14, height: 14, color: "#71717a" }} />
                </div>
              ...
              <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                <div style={{
                  ...
                  <Phone style={{ width: 14, height: 14, color: "#71717a" }} />
                </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <Zap style={{ width: 12, height: 12, color: "#71717a" }} />

...
export function Footer() {
  return (
    <footer style={{
      ...
      <div style={{
        height: 1,
        background: "linear-gradient(90deg, transparent, rgba(29,156,254,0.5), rgba(29,156,254,0.3), transparent)",
      }} />
      ...
      <div style={{
        ...
        background: "radial-gradient(circle, rgba(29,156,254,0.04) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
        ...
        <div style={{
          ...
          <div style={{ maxWidth: 300 }}>
            <Link href="/" style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20, textDecoration: "none" }}>
              <div style={{
                ...
                boxShadow: "0 0 20px rgba(29,156,254,0.3)",
              }}>
            ...
            <div style={{
              ...
              <div style={{ width: 7, height: 7, background: "#1d9cfe", borderRadius: "50%", animation: "pulse-dot 2s infinite" }} />
              <span style={{ fontSize: 11, fontWeight: 700, color: "#1d9cfe", letterSpacing: "0.06em", textTransform: "uppercase" }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              {SOCIALS.map(({ icon: Icon, href, label }) => (
                <a key={label} href={href}
                  ...
                  onMouseEnter={(e) => {
                    e.currentTarget.style.background = "rgba(29,156,254,0.12)";
                    e.currentTarget.style.borderColor = "rgba(29,156,254,0.3)";
                    e.currentTarget.style.color = "#1d9cfe";
          ...
          <div>
            <h4 style={{
              ...
              <span style={{ width: 16, height: 2, background: "#1d9cfe", borderRadius: 99, display: "inline-block" }} />
              Services
            </h4>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              <div style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                <div style={{
                  ...
                  <MapPin style={{ width: 14, height: 14, color: "#1d9cfe" }} />
                </div>
              ...
              <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                <div style={{
                  ...
                  <Mail style={{ width: 14, height: 14, color: "#1d9cfe" }} />
                </div>
              ...
              <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
                <div style={{
                  ...
                  <Phone style={{ width: 14, height: 14, color: "#1d9cfe" }} />
                </div>
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
              <Zap style={{ width: 12, height: 12, color: "#1d9cfe" }} />
